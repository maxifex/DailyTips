...
/**
 * Manages a local database for tip data.
 */
...
//    static final String DATABASE_NAME = "dailies.db";
    private static String DB_NAME = "dailies.db";

    //The Android's default system path of your application database.
    private static String DB_PATH = "/data/data/com.fredua.android.dailies/databases/";
